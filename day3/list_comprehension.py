...
# Name  = "Priyanshu Kumaer"

# charchter = {}

# for char in Name:
#     if char in charchter:
#         charchter[char] +=1
#     else:
#         charchter[char]=1
...
# # for key in data["MAINDATA"][0]["HeaderFields"]:
# count = 0
...
#     new_variable = tuple(list)
#     result = result + new_variable
# print(result)

# test_tuple1 = (10,2,3,5)
# test_tuple2 = (3,6,4,3)
# result = ()
# for i in range(len(test_tuple1)):
#     result +=  (test_tuple1[i]**test_tuple2[i],)
# print(result)
...
# for name in Input:
#     name1,domain = name.split("/server/")
#     name2,domain2 = domain.split("/file_path/")
...
masked_email = mail[0]+"*"*(len(mail)-2)+mail[-1]+"@"+domain
